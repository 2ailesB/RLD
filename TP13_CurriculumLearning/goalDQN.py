"""
    This file contains functions and script to execute the goalDQN algorithm. 
...
class GoalDQN(object):
    ...
    def __init__(self, env, opt):
        ...
        self.replay = opt.replau  # wether we use replay buffer or not
...
if __name__ == '__main__':
    env, config, outdir, logger = init(
        './configs/config_gridworld_goalDQN.yaml', "GoalDQNAgent")
