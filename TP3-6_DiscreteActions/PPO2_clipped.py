...
if __name__ == '__main__':
    env, config, outdir, logger = init(
        './TP3-6_DiscreteActions/configs/config_cartpole_PPO.yaml', "PPO2_clipped")
    ...
    for i in range(episode_count):
        ...
        while True:
            ...
            if done:
                ...
                logger.direct_write("value loss", lossValue, i)
                logger.direct_write("policy loss", lossActor, i)
