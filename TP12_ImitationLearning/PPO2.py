"""
    This file contains functions and script to execute the PPO algorithm. 
...
if __name__ == '__main__':
    env, config, outdir, logger = init(
        './configs/config_PPO_lunar.yaml', "PPO2")
