"""
    ...
    For more informations on algorithms see https://dac.lip6.fr/wp-content/uploads/2021/10/cours-1.pdf.  
"""
...
if __name__ == '__main__':
    env, config, outdir, logger = init(
        './TP3-6_DiscreteActions/configs/config_cartpole_DQN.yaml', "DQN")
    ...
    for i in range(episode_count):
        ...
        while True:
            ...
            if done:
                ...
                logger.direct_write("Q loss", loss, i)
                print
