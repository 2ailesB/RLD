...
class A2C(object):
    ...
    def __init__(self, env, opt):
        ...
        self.actor = NN(self.featureExtractor.outSize, self.action_space.n, layers=opt.ActorLayers, finalActivation=F.softmax, activation=torch.tanh, dropout=0.)  # first NN : learn
...
if __name__ == '__main__':
    env, config, outdir, logger = init(
        './TP3-6_DiscreteActions/configs/config_lunar_A2C.yaml', "A2C")
